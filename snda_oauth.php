...
function getSndaConfig()
{
    $config['appId'] = '4aca8b1b65dace1aa1d0c54de8d160dc';
    $config['appSecret'] = '86d1ceb4e3f6ca4d7e5546d7bb57ce21';
    $config['redirectURI'] = urlencode('http://10.241.34.40/sdo/cb.php');
    return $config;
}
